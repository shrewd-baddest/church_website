          ...
          <div className="flex flex-wrap items-end gap-4">
            <div className="flex-1 min-w-[180px]">
              ...
              <select value={graduationFilter} onChange={e => setGraduationFilter(e.target.value)}
                className="w-48 px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 bg-white max-h-[200px]">
